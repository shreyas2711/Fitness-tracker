...
export const activityLoadAction = ()=>async(dispatch)=>{
    ...
    try{
        const {data} = await axios.get('https://fitness-tracker-vag4.onrender.com/api/activity/show');
...
export const activityDeleteAction = (activityId)=>async(dispatch)=>{
    dispatch({type:ACTIVITY_DELETE_REQUEST});
        ...
        try{
            ...
            const {data} = axios.delete(`https://fitness-tracker-vag4.onrender.com/api/activity/delete/${activityId}`);
...
export const createActivity = (activityData)=>async(dispatch)=>{
    ...
    try{
        ...
        const {data} = await axios.post('https://fitness-tracker-vag4.onrender.com/api/activity/create',activityData);
...
export const createNutrition = (nutritionData)=>async(dispatch)=>{
    ...
    try{
        ...
        const {data} = await axios.post('https://fitness-tracker-vag4.onrender.com/api/nutrition/create',nutritionData);
